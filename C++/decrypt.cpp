...
void Decrypt::decryptData(	unsigned char * pData)
{
...
//	cout<<"---------------------------------------------2------------------------\n";
    ...
    string msgstr;
	ifstream infile;
	infile.open("C:/Users/USER/Documents/GitHub/AnalisisAlgoritmosProyectoII/aes-master/message.aes", ios::in | ios::binary);
